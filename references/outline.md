...
- **Index-build cost**: not free, scales with corpus size. Negligible for a single month, substantial for 60 years (concrete USD + GPU-hour estimate in the appendix).
