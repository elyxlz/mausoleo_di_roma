...
config = OcrPipelineConfig(
    name="exp_011_col3_raw_cleanup_7b",
    operators=[
        ...
        LlmCleanup(model="Qwen/Qwen2.5-7B-Instruct", prompt=prompts.LLM_CLEANUP_V2, backend="vllm", max_tokens=12288, max_model_len=24576),
        ParseIssue(),
    ],
)
