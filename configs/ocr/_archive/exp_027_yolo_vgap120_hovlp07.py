...
config = OcrPipelineConfig(
    name="exp_027_yolo_vgap120_hovlp07",
    operators=[
        YoloCrop(conf_threshold=0.2, gpu_fraction=0.3, min_region_area=3000, merge_vertical_gap=120, merge_horizontal_overlap=0.7),
